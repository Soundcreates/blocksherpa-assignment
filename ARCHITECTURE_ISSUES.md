# REChain - Architecture Issues Document

> **Project:** Real Estate Website (REChain)
> **Type:** Test Project For Candidates
...
**Standard Format:**(Only For Development)
...
|---------|-------|----------|
| Auth Token | `token` | `REChain_token` |
| Admin Flag | `isAdmin` | N/A |
| User Data | N/A | `REChain_user` |

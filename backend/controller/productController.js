...
const addproperty = async (req, res) => {
    try {
        const { title, location, price, beds, baths, sqm, type, availability, description, amenities, phone, googleMapLink } = req.body;
...
const updateproperty = async (req, res) => {
    try {
        const { id, title, location, price, beds, baths, sqm, type, availability, description, amenities, phone, googleMapLink } = req.body;

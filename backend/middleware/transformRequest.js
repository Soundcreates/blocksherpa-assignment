 ...
 *
 * Frontend sends:
 *   { city, locality, price: { min, max }, type, category, T, possession }
 *
 * Backend expects:
 *   { city, locality, T, minPrice, maxPrice (Crores string),
 *     propertyType, propertyCategory, possession, limit }
 */
export const transformAISearchRequest = (req, res, next) => {
  const { city, locality, price, type, category, T, possession, includeNoBroker } = req.body;

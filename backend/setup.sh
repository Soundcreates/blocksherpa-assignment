...
# REChain Backend Quick Setup Script
# This script helps you set up the REChain backend quickly
...
# Header
print_header "🏠 REChain Backend Setup"
print_header "============================"
echo ""
...
MONGO_URI=mongodb://localhost:27017/REChain
